...
plot(2:23, rs$adjr2, xlab="No of parameters", ylab="Adj R2")
mtext("Figure 13: Test-based Procedures For Math Score", side = 3, line = - 2, outer = TRUE, cex = 1.5)
...
mtext("Figure 14: Reading Score Model Box-Cox Likelihood", side = 3, line = - 2, outer = TRUE)
